...
<html>
    <head>
        <meta charset="utf-8"/>-
        <title>Gamermelon: Softwares</title>
    ...
    <body>
        ...
        <main>
            ...
            <div class="tags-column">
                ...
                <input tabindex="1" type="checkbox" name="tags" id="antivirus" value="antivirus">ANTIVIRUS<br><br>                
                <input tabindex="2" type="checkbox" name="tags" id="audio_editor" value="audio_editor">AUDIO EDITOR<br><br>
                <input tabindex="3" type="checkbox" name="tags" id="communication" value="communication">COMMUNICATION<br><br>
                <input tabindex="4" type="checkbox" name="tags" id="data_management" value="data_management">DATA MANAGEMENT<br><br>
                <input tabindex="5" type="checkbox" name="tags" id="documentation" value="documentation">DOCUMENTATION<br><br>
                <input tabindex="6" type="checkbox" name="tags" id="educational" value="educational">EDUCATIONAL<br><br>
                ...
                <input tabindex="7" type="checkbox" name="tags" id="financial" value="financial">FINANCIAL<br><br>
                <input tabindex="8" type="checkbox" name="tags" id="game_engine" value="game_engine">GAME ENGINE<br><br>
                <input tabindex="9" type="checkbox" name="tags" id="graphics_art" value="graphics_art">GRAPHICS ART<br><br>
                <input tabindex="10" type="checkbox" name="tags" id="open-source" value="open-source">OPEN-SOURCE<br><br>
                <input tabindex="11" type="checkbox" name="tags" id="screencasting" value="screencasting">SCREENCASTING<br><br>
                <input tabindex="12" type="checkbox" name="tags" id="video_editor" value="video_editor">VIDEO EDITOR<br><br>
                <input tabindex="13" type="button" name="tags" id="apply"
                value="APPLY" style="font-family: retroComputer; color: white;
                background-color: rgb(39, 8, 8); border: none;">
                <input tabindex="14" type="reset" name="tags" id="clear" value="CLEAR"
                style="font-family: retroComputer; color: white;
                background-color: rgb(39, 8, 8); border: none;"><br><br>
            </form>
            </div> <!-- tags-column -->
            <div class="games-main">
                <div class="games-main-title">ALL SOFTWARES</div>
                    <div style="float:left; padding-right: 6px; padding-left: 4px;" id="Paintception">
                        <button class="basket" onclick="AddItem('Paintception')" style="left: 72.15%;">
                        <img src="media/basket.png" alt="basket_icon" class="basket"/></button>
                        <img src="media/paintception.png" alt="paintception_banner"
                        width="220px" height="140px"/>
                    </div>
                    <div style="float:left; padding-right: 6px;" id="Faural">
                        <button class="basket" onclick="AddItem('Faural')">
                        <img src="media/basket.png" alt="basket_icon" class="basket"/></button>
                        <img src="media/faural.png" alt="faural_banner"
                        width="220px" height="140px"/>
                    </div>
            </div>
        </div>
